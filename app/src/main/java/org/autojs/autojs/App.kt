...
class App : Application() {
    ...
    private fun init() {
        ThemeColorManagerCompat.init(this, ThemeColor(resources.getColor(R.color.colorPrimary, null), resources.getColor(R.color.colorPrimaryDark, null), resources.getColor(R.color.colorAccent, null)))
